...
* (Only available in the **Japanese** version due to the Spin Jump method of the glitch only being possible in the **Japanese** version): When the **Adjust X-Naut's Position** option is enabled, the X-Naut in the Great Tree room where the glitch is performed will be locked to the bottom-left of the room until Mario is standing at the required position and is not in Paper Mode. Upon this happening, the X-Naut will be placed near Mario, and will be placed at a random Z coordinate.
