#ifndef TTYD_ANIMDRV_H
#define TTYD_ANIMDRV_H
...
extern "C"
{
    ...
    void _animPoseDrawMtx(AnimPose *pose, const mtx34 *mat, int32_t wXluStage, float rotY, float scale);
    void animPoseDrawMtx(int32_t poseId, const mtx34 *mat, int32_t wXluStage, float rotY, float scale);
    // animSetPaperTexObj
    ...
    void animSetPaperTexMtx(const mtx34 *mat0, const mtx34 *mat1, const mtx34 *mat2);
    ...
    void animPoseVivianMain(int32_t poseId, const Vec3 *position);
    int32_t animPoseGetVivianType(int32_t poseId);

    void animPoseSetDispCallBack(int32_t poseId, void (*dispCb)(void *user, int32_t groupId, mtx34 *mat), void *user);
