...
enum CheatsEnabledFlagOrder
{
    CHEATS_ENABLED_FLAG_ORDER_WALK_THROUGH_WALLS,
    CHEATS_ENABLED_FLAG_ORDER_FALL_THROUGH_FLOORS,
    CHEATS_ENABLED_FLAG_ORDER_SAVE_COORDINATES,
    CHEATS_ENABLED_FLAG_ORDER_LOAD_COORDINATES,
    CHEATS_ENABLED_FLAG_ORDER_SPAWN_ITEM,
    CHEATS_ENABLED_FLAG_ORDER_SAVE_ANYWHERE,
    CHEATS_ENABLED_FLAG_ORDER_TEXT_STORAGE,
    CHEATS_ENABLED_FLAG_ORDER_TIME_STOP_TEXT_STORAGE,
    CHEATS_ENABLED_FLAG_ORDER_SPEED_UP_MARIO,
    CHEATS_ENABLED_FLAG_ORDER_DISABLE_BATTLES,
    CHEATS_ENABLED_FLAG_ORDER_AUTO_ACTION_COMMANDS,
    CHEATS_ENABLED_FLAG_ORDER_INFINITE_ITEM_USAGE,
    CHEATS_ENABLED_FLAG_ORDER_RELOAD_ROOM,
    CHEATS_ENABLED_FLAG_ORDER_LEVITATE,
    CHEATS_ENABLED_FLAG_ORDER_AUTO_MASH_TEXT,
    CHEATS_ENABLED_FLAG_ORDER_FRAME_ADVANCE,
    CHEATS_ENABLED_FLAG_ORDER_GENERATE_LAG_SPIKE,
    CHEATS_ENABLED_FLAG_ORDER_LOCK_MARIO_HP_TO_MAX,
    CHEATS_ENABLED_FLAG_ORDER_LOCK_PARTNER_HP_TO_MAX,
    CHEATS_ENABLED_FLAG_ORDER_RUN_FROM_BATTLES,
    CHEATS_ENABLED_FLAG_ORDER_BOBBERY_EARLY,
    CHEATS_ENABLED_FLAG_ORDER_FORCE_NPC_ITEM_DROP,

    CHEATS_ENABLED_FLAG_ORDER_MARIO_COORDINATES_MODIFY_AS_HEX,

    CHEATS_ENABLED_FLAG_ORDER_DISABLE_SOUNDS_PAUSE_MENU_Z_MENU,
    CHEATS_ENABLED_FLAG_ORDER_DISABLE_SOUNDS_BACKGROUND_MUSIC,
    CHEATS_ENABLED_FLAG_ORDER_DISABLE_SOUNDS_ENVIRONMENT_SOUNDS,

    CHEATS_ENABLED_FLAG_ORDER_SIMULATE_AMW_MARIO_ZERO_HITBOX_PAPER_MODE,
    CHEATS_ENABLED_FLAG_ORDER_SIMULATE_AMW_MARIO_ZERO_HITBOX_ROOM_TRANSITION,
    CHEATS_ENABLED_FLAG_ORDER_SIMULATE_AMW_MARIO_WALK_ON_AIR,

    CHEATS_ENABLED_FLAG_ORDER_MAX_VALUE, // Don't use this directly other than for defines
};
