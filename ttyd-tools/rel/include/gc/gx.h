...
void GXSetVtxAttrFmt(GXVtxFmt vtxfmt, GXAttribute attribute, 
	GXComponentContents contents, GXComponentType type, uint8_t fracBits);

void GXSetTexCoordGen2(GXTexCoordID dstCoord, GXTexGenType func, 
	GXTexGenSrc srcParam, uint32_t mtx, bool normalize, uint32_t postMtx);
...
void GXSetAlphaCompare(GXCompare func0, uint8_t reference0, 
	GXAlphaOperation operation, GXCompare func1, uint8_t reference1);

void GXSetTevOrder(GXTevStageID stage, GXTexCoordID coord, GXTexMapID map, GXChannelID color);
void GXSetNumTevStages(uint8_t nStages);

void GXSetBlendMode(GXBlendMode type, GXBlendFactor srcFactor, 
	GXBlendFactor dstFactor, GXLogicOperation operation);
...
void GXSetViewport(float posX, float posY, float width, 
	float height, float nearDepth, float farDepth);
