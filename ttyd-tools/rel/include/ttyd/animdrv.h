...
void animPoseSetMaterialEvtColor(int32_t poseId, const uint8_t *color[4]);
uint32_t animPoseGetMaterialFlag(int32_t poseId);
uint32_t animPoseGetMaterialLightFlag(int32_t poseId);
uint8_t *animPoseGetMaterialEvtColor(int32_t poseId);
...
void _animPoseDrawMtx(AnimPose *pose, const gc::mtx::mtx34 *mat, int32_t wXluStage, float rotY, float scale);
void animPoseDrawMtx(int32_t poseId, const gc::mtx::mtx34 *mat, int32_t wXluStage, float rotY, float scale);
// animSetPaperTexObj
...
void animSetPaperTexMtx(const gc::mtx::mtx34 *mat0, const gc::mtx::mtx34 *mat1, const gc::mtx::mtx34 *mat2);
...
void animPoseVivianMain(int32_t poseId, const gc::mtx::Vec3 *position);
int32_t animPoseGetVivianType(int32_t poseId);

void animPoseSetDispCallBack(int32_t poseId, void (*dispCb)(void *user, int32_t groupId, gc::mtx::mtx34 *mat), void *user);
