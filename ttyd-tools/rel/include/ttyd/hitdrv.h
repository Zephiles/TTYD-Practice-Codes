...
struct HitCheckQuery
{
    ...
    uint32_t wUser0;
    uint32_t wUser1;
    gc::mtx::Vec3 targetPosition;
    gc::mtx::Vec3 targetDirection;
    gc::mtx::Vec3 hitPosition;
    gc::mtx::Vec3 hitNormal;
...
{
    gc::mtx::Vec3 worldSpaceVertex0Position;
    gc::mtx::Vec3 worldSpaceVertex1Position;
    gc::mtx::Vec3 worldSpaceVertex2Position;
    gc::mtx::Vec3 edgeV0V2;
    gc::mtx::Vec3 edgeV1V0;
    gc::mtx::Vec3 edgeV2V1;
    gc::mtx::Vec3 realNormal;
} __attribute__((__packed__));
...
struct HitEntry
{
    ...
    gc::mtx::mtx34 localSpaceToWorldSpaceMatrix;
    gc::mtx::mtx34 wTransformMtx_2;

    uint8_t gap_6c[0x30];

    gc::mtx::Vec3 localSpaceOrigin;
...
// local: _hitEnt
// local: hitEntrySub
HitEntry *hitEntry(void *pJoint, gc::mtx::mtx34 *mat, int supgroupIndex);
HitEntry *hitEntryMOBJ(void *pJoint, gc::mtx::mtx34 *mat);
...
void hitReCalcMatrix(HitEntry *hit, gc::mtx::mtx34 *mat);
...
void hitObjGetPos(const char *mapobjName, gc::mtx::Vec3 *pOutPosition);
void hitObjGetNormal(const char *mapobjName, gc::mtx::Vec3 *pOutNormal);
...
gc::mtx::Vec3 *hitGetDamageReturnPos(HitEntry *hit);
