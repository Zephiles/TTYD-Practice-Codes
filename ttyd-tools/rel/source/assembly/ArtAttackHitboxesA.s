...
lis %r4,ArtAttackHitboxesEnabled@ha
lbz %r4,ArtAttackHitboxesEnabled@l(%r4)
cmpwi %r4,0
beq+ CurrentlyOff
...
ButtonInput:
lis %r28,ArtAttackHitboxesCombo@ha
lhz %r28,ArtAttackHitboxesCombo@l(%r28)
lis %r26,button_input_high
lhz %r26,button_input_low(%r26)
and %r26,%r26,%r28
cmpw %r26,%r28
bne+ AcceptButtonInputs
lis %r26,ArtAttackHitboxesDenyInputs@ha
lbz %r27,ArtAttackHitboxesDenyInputs@l(%r26)
cmpwi %r27,0 # Currently accepting inputs
bne+ Exit
li %r27,1 # Refuse further inputs
stb %r27,ArtAttackHitboxesDenyInputs@l(%r26)
blr

AcceptButtonInputs:
li %r27,0 # Reset flag if no button combo is pressed/held
lis %r26,ArtAttackHitboxesDenyInputs@ha
stb %r27,ArtAttackHitboxesDenyInputs@l(%r26)
b Exit

StoreFlag:
lis %r26,ArtAttackHitboxesEnabled@ha
stb %r27,ArtAttackHitboxesEnabled@l(%r26) # On/Off Flag
