...
void Mod::reloadScreen()
{
  if ((ttyd::system::keyGetButton(0) & ReloadScreenCombo) == (ReloadScreenCombo))
  {
    ...
    {
      #ifdef TTYD_US
        uint32_t unkDisplayAddress = r13 + 0x1700;
        uint32_t unkCameraDisplayAddress = 0x803C95F8;
        uint32_t NextSeqAddress = r13 - 0x7D8C;
        uint32_t SeqAddress = r13 - 0x7D90;
      #elif defined TTYD_JP
        uint32_t unkDisplayAddress = r13 + 0x11A0;
        uint32_t unkCameraDisplayAddress = 0x803C5A78;
        uint32_t NextSeqAddress = r13 - 0x7DAC;
        uint32_t SeqAddress = r13 - 0x7DB0;
      #elif defined TTYD_EU
        uint32_t unkDisplayAddress = r13 + 0x17E0;
        uint32_t unkCameraDisplayAddress = 0x803D5658;
        uint32_t NextSeqAddress = r13 - 0x7D8C;
        uint32_t SeqAddress = r13 - 0x7D90;
      #endif
      
      unkDisplayAddress = *reinterpret_cast<uint32_t *>(unkDisplayAddress);
      unkCameraDisplayAddress = *reinterpret_cast<uint32_t *>(unkCameraDisplayAddress);
