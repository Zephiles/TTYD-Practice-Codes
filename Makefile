...
CFLAGS		= -nostdlib -ffunction-sections -fdata-sections -fno-shrink-wrap -g -Oz -Wall -Werror -Wextra -Wformat-overflow=0 -Wno-class-memaccess -Wno-uninitialized -Wno-cast-function-type -Wno-address-of-packed-member $(MACHDEP) $(INCLUDE)
