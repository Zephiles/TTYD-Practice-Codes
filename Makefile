...
CFLAGS		= -nostdlib -ffreestanding -ffunction-sections -fdata-sections -fno-optimize-sibling-calls -g -Os -Wall -Werror -Wextra -Wformat-overflow=0 -Wno-address-of-packed-member $(MACHDEP) $(INCLUDE)
