...
CFLAGS		= -nostdlib -ffunction-sections -fdata-sections -fno-shrink-wrap -g -Oz -Wall -Werror -Wextra -Wformat=2 -Wno-format-nonliteral -Wno-class-memaccess -Wno-uninitialized -Wno-cast-function-type -Wno-array-bounds -Wno-address-of-packed-member $(MACHDEP) $(INCLUDE)
